    ...
    function (t, n, e) {
      ...
      (n.__esModule = !0),
        (n.createPath =
          ...
          n.locationsAreEqual =
          n.createLocation =
          n.createMemoryHistory =
          n.createHashHistory =
          n.createBrowserHistory =
            void 0);
      var r = e(2);
      ...
      var a = e(7),
        ...
        f = e(9),
        l = o(f);
      (n.createBrowserHistory = c.default),
        (n.createHashHistory = s.default),
        (n.createMemoryHistory = l.default);
    },
    function (t, n) {
      "use strict";
      n.__esModule = !0;
      (n.addLeadingSlash = function (t) {
        return "/" === t.charAt(0) ? t : "/" + t;
      }),
        (n.stripLeadingSlash = function (t) {
          return "/" === t.charAt(0) ? t.substr(1) : t;
        }),
        (n.stripPrefix = function (t, n) {
          return 0 === t.indexOf(n) ? t.substr(n.length) : t;
        }),
        ...
        (n.parsePath = function (t) {
          ...
          var i = n.indexOf("?");
          return (
            i !== -1 && ((e = n.substr(i)), (n = n.substr(0, i))),
            (n = decodeURI(n)),
            {
              pathname: n,
              search: "?" === e ? "" : e,
          ...
          var n = window.history,
            ...
            P = function (t) {
              var n = t || {},
                ...
                f = a + c + u;
              return (
                w && (f = (0, s.stripPrefix)(f, w)),
                r({}, (0, s.parsePath)(f), { state: o, key: e })
              );
            },
            b = function () {
            ...
            L = function (t) {
              (0, d.isExtraneousPopstateEvent)(t) || A(P(t.state));
            },
            S = function () {
              A(P(p()));
            },
            ...
            H = function (t, o) {
              var r = "PUSH",
                i = (0, u.createLocation)(t, o, b(), G.location);
              O.confirmTransitionTo(i, r, y, function (t) {
                if (t) {
                  var o = T(i),
                    ...
                    u = i.state;
                  if (e)
                    if ((n.pushState({ key: c, state: u }, null, o), a))
                      window.location.href = o;
                    else {
                      var s = M.indexOf(G.location.key),
                        f = M.slice(0, s === -1 ? 0 : s + 1);
                      f.push(i.key), (M = f), x({ action: r, location: i });
                    }
              ...
              O.confirmTransitionTo(i, r, y, function (t) {
                if (t) {
                  var o = T(i),
                    ...
                    u = i.state;
                  if (e)
                    if ((n.replaceState({ key: c, state: u }, null, o), a))
                      window.location.replace(o);
                    else {
                      var s = M.indexOf(G.location.key);
                      s !== -1 && (M[s] = i.key), x({ action: r, location: i });
                    }
            ...
            q = function (t) {
              (I += t),
                1 === I
                  ? ((0, d.addEventListener)(window, h, L),
                    o && (0, d.addEventListener)(window, v, S))
                  : 0 === I &&
                    ((0, d.removeEventListener)(window, h, L),
                    o && (0, d.removeEventListener)(window, v, S));
            },
            B = !1,
            F = function () {
              var t =
    ...
    function (t, n, e) {
      ...
      var r =
        ...
        m = function () {
          ...
          var n = window.history,
            e =
              ((0, d.supportsGoWithoutReloadUsingHash)(),
            ...
            b = function () {
              var t = P(p());
              return f && (t = (0, s.stripPrefix)(t, f)), (0, s.parsePath)(t);
            },
            O = (0, l.default)(),
            x = function (t) {
              r(V, t),
            ...
            E = function () {
              ...
              if (t !== n) g(n);
                ...
                var e = b(),
                  o = V.location;
                if (!L && (0, u.locationsAreEqual)(o, e)) return;
          ...
          var T = b(),
              ...
              O.confirmTransitionTo(r, e, o, function (t) {
                if (t) {
                  ...
                  if (i) {
                    ...
                    c.push(n), (H = c), x({ action: e, location: r });
                  } else x();
                }
              });
            },
            U = function (t, n) {
              ...
              O.confirmTransitionTo(r, e, o, function (t) {
                if (t) {
                  ...
                  a !== -1 && (H[a] = n), x({ action: e, location: r });
                }
              });
            },
            R = function (t) {
            ...
            F = function (t) {
              (B += t),
                1 === B
                  ? (0, d.addEventListener)(window, h, E)
                  : 0 === B && (0, d.removeEventListener)(window, h, E);
            },
            D = !1,
            G = function () {
              var t =
          ...
          var t =
            ...
            g = o.map(function (t) {
              return "string" == typeof t
                ? (0, c.createLocation)(t, void 0, p())
                : (0, c.createLocation)(t, void 0, t.key || p());
            }),
            m = a.createPath,
            w = function (t, e) {
              var o = "PUSH",
                r = (0, c.createLocation)(t, e, p(), A.location);
              h.confirmTransitionTo(r, o, n, function (t) {
                if (t) {
                  var n = A.index,
                    e = n + 1,
                    i = A.entries.slice(0);
                  i.length > e ? i.splice(e, i.length - e, r) : i.push(r),
                    v({ action: o, location: r, index: e, entries: i });
                }
              });
            },
            P = function (t, e) {
              var o = "REPLACE",
                r = (0, c.createLocation)(t, e, p(), A.location);
              h.confirmTransitionTo(r, o, n, function (t) {
                t && ((A.entries[A.index] = r), v({ action: o, location: r }));
              });
            },
            b = function (t) {
              var e = f(A.index + t, 0, A.entries.length - 1),
                o = "POP",
                r = A.entries[e];
              h.confirmTransitionTo(r, o, n, function (t) {
                t ? v({ action: o, location: r, index: e }) : v();
              });
            },
            O = function () {
              return b(-1);
      ...
      var e = function (t) {
        ...
        r = function (t) {
          var n =
            ...
            u = a || c;
          if (
            (t && e(t) ? (i = r) : r.length && (i.pop(), (i = i.concat(r))),
            !i.length)
          )
            return "/";
          var s = void 0;
    ...
    function (t, n) {
      ...
      var e =
        ...
        o = function t(n, o) {
          ...
          var r = "undefined" == typeof n ? "undefined" : e(n),
            i = "undefined" == typeof o ? "undefined" : e(o);
          if (r !== i) return !1;
          if ("object" === r) {
            var a = n.valueOf(),
              c = o.valueOf();
            if (a !== n || c !== o) return t(a, c);
            var u = Object.keys(n),
              s = Object.keys(o);
            return (
              u.length === s.length &&
